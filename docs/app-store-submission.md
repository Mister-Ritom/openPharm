...
**App Name:** OpenPharma: Food Insight
**Subtitle:** Understand what's really in your food.
**Categories:** Health & Fitness, Food & Drink

## Short Description

OpenPharma: Scan food, get AI-powered clinical nutrition insights fast.
...
- A correction flow that allows users to instantly override incorrect or missing data with a fresh photo scan.
